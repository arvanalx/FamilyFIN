...
const TRANSLATIONS = {
  el: {
    ...
    dash_balance_chart:    'Μεταβολές Λογαριασμών',
    dash_monthly_stats:    'Ισοζύγιο Κινήσεων Μήνα',
    stat_income:           'Έσοδα',
    stat_expense:          'Έξοδα',
    stat_balance:          'Υπόλοιπο',
    dash_credit_cards:     'Υπόλοιπα Πιστωτικών Καρτών',
    dash_expense_by_cat:   'Έξοδα ανά Κατηγορία',
    dash_expense_by_month: 'Έξοδα ανά Μήνα',
    ...
    dash_total:            'Σύνολο',
    dash_daily_balance:    'Υπόλοιπα ανά Ημέρα',
    dash_installments_pm:  'δόσεις/μήνα',
    dash_tx_pm:            'κινήσεις/μήνα',
    ...
    label_sub_paused:   'Σε Παύση (δεν δημιουργούνται αυτόματες κινήσεις)',
    sub_paused_badge:   '⏸ Παύση',
    ...
    action_copy_next_month: 'Αντιγραφή στον επόμενο μήνα',
    ...
    btn_gen_next_month:      'Δημιουργία κίνησης επόμενου μήνα',
    toast_sub_next_created:  'Κίνηση επόμενου μήνα δημιουργήθηκε',
    toast_sub_next_exists:   'Η κίνηση επόμενου μήνα υπάρχει ήδη',
    ...
    confirm_del_sub_msg:  'Να διαγραφεί αυτή η συνδρομή;\nΟι κινήσεις που έχουν ήδη καταχωρηθεί θα παραμείνουν.',
  ...
  en: {
    ...
    label_sub_paused:   'Paused (no automatic transactions generated)',
    sub_paused_badge:   '⏸ Paused',
    ...
    action_copy_next_month: 'Copy to next month',
    ...
    btn_gen_next_month:      'Generate next month transaction',
    toast_sub_next_created:  'Next month transaction created',
    toast_sub_next_exists:   'Next month transaction already exists',
